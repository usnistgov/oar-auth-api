...
import auth.saml.service.provider.config.CustomFilter;
import auth.saml.service.provider.exceptions.ConfigurationException;
import auth.saml.service.provider.service.SamlUserDetailsService;
...
//	}
	...
	public Protocol socketFactoryProtocol() throws ConfigurationException {
		return new Protocol("https", socketFactory(), samlPort);
	}
	...
	public SAMLContextProviderImpl contextProvider() throws ConfigurationException {
		...
		samlContextProviderLB.setServerPort(samlPort);
...
//        String fedMetadataURL = "federationmetadata.xml";
